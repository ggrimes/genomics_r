...
```{r where_am_i}
# lines beging with # are comments
# Find out where you are using getwd()
getwd()
```
...
```{r}
# print content of object gene_name to screen
gene_name
```
