...
\`\`\`{\# Use the function str() on vector snp_genes}
    ...
    -   `snp_chromosomes` contains `3, 11, X, 6`

    -   `snp_positions` contains `8762685, 66560624, 67545785, 154039662`
...
We can verify that `snp_genes` contains the new gene entry by evaulating
the object
...
Let's add gene name "APOA5" add the 6th item of the vector using
`[ ]`notation
